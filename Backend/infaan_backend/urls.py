...
from accounts.views import AdminRegisterView, LoginView, RegisterView, UserViewSet, profile
from catalog.views import PackagePriceViewSet, ServicePackageViewSet, ServiceViewSet, SubscriptionViewSet
